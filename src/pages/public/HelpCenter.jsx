...
const HelpCenter = () => {
    ...
    const faqs = [
        ...
        // Group Finance
        { category: 'Group Finance & Kitties', question: 'What exactly is a "Kitty" on Qomrade?', answer: 'A kitty is a group savings instrument. Think of it as a communal piggy bank with transparent rules. The kitty administrator sets contribution schedules (e.g., $10/month from each member), withdrawal conditions, and governance rules. Members can track contributions and balances in real-time. Kitties are perfect for: savings groups (chamas), event funds, project budgets, emergency funds, and community investment pools.' },
