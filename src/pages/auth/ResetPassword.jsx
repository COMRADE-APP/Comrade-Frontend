        ...
        <div className="min-h-screen flex items-center justify-center p-8 bg-base">
            <div className="w-full max-w-md bg-elevated rounded-xl shadow-lg p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-secondary">Enter verification code and your new password.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-2 border rounded-lg bg-base"
                            disabled={!!emailFromUrl}
                        />
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-secondary mb-2">Verification Code</label>
