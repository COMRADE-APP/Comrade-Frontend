...
const METHOD_COLORS = {
    ...
    comrade_balance: 'from-primary-600 to-primary-600',
};
    ...
    return (
        <div className="space-y-2">
            ...
            <button
                ...
                className="w-full flex items-center gap-3 p-4 rounded-2xl border-2 border-primary-600/40 bg-primary-600/5 hover:bg-primary-600/10 transition-all text-left"
            >
            ...
            {expanded && (
                <div className="mt-1 rounded-2xl border border-theme bg-elevated shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                    {allOptions.map((method) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className={`text-sm font-medium truncate ${isSelected ? 'text-primary-700 dark:text-primary-500' : 'text-primary'}`}>
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-3.5 text-left text-primary-700 dark:text-primary-500 hover:bg-primary-600/5 transition-colors"
                    >
                        <div className="w-9 h-9 rounded-xl border-2 border-dashed border-primary-500/50 flex items-center justify-center">
