        ...
        <section id="services" className="py-24 bg-gray-50 dark:bg-gray-950 border-y border-gray-200 dark:border-white/10 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-white/10 text-blue-600 dark:text-blue-300 text-sm font-bold mb-6 border border-blue-200 dark:border-white/20">
                        <Settings size={16} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-min md:auto-rows-[250px]">
                    {/* Big Unified Marketplace Card */}
                    <div className="md:col-span-2 lg:col-span-2 row-span-2 bg-gradient-to-br from-blue-600 to-indigo-800 rounded-[40px] p-10 flex flex-col justify-between text-white shadow-xl group overflow-hidden relative">
                    ...
                    {/* Small Finance Card */}
                    <div className="bg-white dark:bg-gray-900 rounded-[40px] p-8 border border-gray-200 dark:border-white/10 shadow-md flex flex-col items-center justify-center text-center hover:shadow-xl transition-shadow">
                    ...
                    {/* Small P2P Card */}
                    <div className="bg-gray-900 dark:bg-gray-800 rounded-[40px] p-8 shadow-xl flex flex-col items-center justify-center text-center text-white">
                    ...
                    <div className="md:col-span-2 lg:col-span-2 bg-gradient-to-tr from-emerald-500 to-green-700 rounded-[40px] p-8 flex flex-col sm:flex-row items-center gap-6 text-white shadow-xl hover:-translate-y-1 transition-transform">
