            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="flex-1 w-full relative">
                        ...
                        <div className="absolute -bottom-8 -right-8 bg-white/90 dark:bg-white/10 backdrop-blur-xl border border-gray-200 dark:border-white/20 p-6 rounded-2xl shadow-xl w-64 hidden md:block z-20">
                    ...
                    <div className="flex-1 w-full relative z-20">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-white/10 backdrop-blur-md border border-blue-200 dark:border-white/20 text-blue-600 dark:text-blue-200 text-sm font-bold mb-6">
                            <Globe size={16} />
                            <span>About Us</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight">Our Core Mission</h2>
                        <p className="text-lg text-gray-600 dark:text-primary-100 font-medium mb-8 leading-relaxed">
