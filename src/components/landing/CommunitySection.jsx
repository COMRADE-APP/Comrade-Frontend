        ...
        <section id="community" className="py-24 bg-gray-50 dark:bg-gray-950 relative z-20">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-100 dark:bg-white/10 text-purple-600 dark:text-purple-300 text-sm font-bold mb-6 border border-purple-200 dark:border-white/20">
                        <Users size={16} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={idx} className="bg-white dark:bg-white/5 backdrop-blur-md p-8 rounded-[32px] shadow-lg border border-gray-200 dark:border-white/10 hover:-translate-y-2 hover:border-gray-300 dark:hover:border-white/20 transition-all duration-300">
                ...
                <div className="mt-16 w-full py-16 px-6 min-h-[300px] md:h-[400px] bg-gradient-to-br from-indigo-900 to-gray-900 dark:from-gray-800 dark:to-indigo-900 rounded-[40px] overflow-hidden relative shadow-2xl flex items-center justify-center">
